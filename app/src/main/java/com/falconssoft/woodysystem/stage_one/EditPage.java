...
//                            tableLayout.removeAllViews();
    ...
    void supplierDialog (){
        ...
        adapter = new SuppliersAdapter(null, suppliers, this, null,1,null,null,null,null);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.editPage_search_supplier:
                ...
                recyclerView = searchDialog.findViewById(R.id.search_supplier_recyclerView);
                recyclerView.setLayoutManager(new LinearLayoutManager(this));
                adapter = new SuppliersAdapter(null, suppliers, this, null,0,null,null,null,null);
                recyclerView.setAdapter(adapter);
