...
public class ItemsListAdapter3 extends BaseAdapter {
    ...
    public ItemsListAdapter3(Context context, List<BundleInfo> itemsList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        view = View.inflate(context, R.layout.item_row3, null);
