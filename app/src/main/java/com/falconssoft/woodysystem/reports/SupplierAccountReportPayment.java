...
//                filters();
    ...
    void supplierDialog(){
        ...
        suppliersAdapter = new SuppliersAdapter(null, suppliers, null, null,0,null,null,SupplierAccountReportPayment.this);
...
//                    filters();
    ...
    public void filter(String charText) { // by Name
        ...
        suppliersAdapter = new SuppliersAdapter(null, arraylist, null, null,0,null,null,SupplierAccountReportPayment.this);
        recyclerView.setAdapter(suppliersAdapter);
    }
