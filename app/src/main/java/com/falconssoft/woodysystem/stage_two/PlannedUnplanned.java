...
public class PlannedUnplanned extends AppCompatActivity implements View.OnClickListener {
    ...
    private class JSONTask extends AsyncTask<String, String, List<CustomerInfo>> {
        ...
        protected void onPostExecute(final List<CustomerInfo> result) {
            ...
            if (result != null) {
                ...
                Toast.makeText(PlannedUnplanned.this, "Not able to fetch data from server, please check url.", Toast.LENGTH_SHORT).show();
            }
        }
    }  // import customers
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                if (s.contains("PLANNED_PACKING_LIST SUCCESS")) {
                    Toast.makeText(PlannedUnplanned.this, "Loaded!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(PlannedUnplanned.this, "Failed to export data!", Toast.LENGTH_SHORT).show();
                    Log.e("tag", "Failed to export data!");
                }

            } else {
                Toast.makeText(PlannedUnplanned.this, "No internet connection!", Toast.LENGTH_SHORT).show();
            }
        }
    }
