...
public class AddSupplier2Adapter extends RecyclerView.Adapter<AddSupplier2Adapter.AddSupplierViewHolder> {

    private List<SupplierInfo> list = new ArrayList<>();
    private AddNewSupplier context;

    public AddSupplier2Adapter(Context context, List<SupplierInfo> list) {
        this.list = list;
        this.context = (AddNewSupplier) context;
    }
